...
public class CourseController extends JPanel implements Observer, ChangeListener, ActionListener {
	...
	public CourseController(CourseData courses) {
		...
		JScrollPane scrollPane = new JScrollPane(coursePanel, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
	...
	/**
	 * Manages the creation of a new course. Called when the "New Course" button is
	 * pressed.
	 * 
	 * @param arg0 not used
	 */
	...
	public static void main(String[] args) {
		...
		ChartObserver chart = new ChartObserver(data);

		JScrollPane scrollPane = new JScrollPane(chart, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
